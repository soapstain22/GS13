...
SUBSYSTEM_DEF(skills)
	...
	var/list/level_names = list("level 0", "level 1", "level 2", "level3", "level 4", "level 5", "level 6 (MAX)") //List of skill level names. Note that indexes can be accessed like so: level_names[SKILL_LEVEL_NOVICE]
