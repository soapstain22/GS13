...
/obj/item/clothing/head/helmet/space/hardsuit/deathsquad
	...
	armor = list("melee" = 80, "bullet" = 80, "laser" = 50, "energy" = 60, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1)
	strip_delay = 130
...
/obj/item/clothing/head/helmet/space/pirate
	...
	armor = list("melee" = 30, "bullet" = 50, "laser" = 30,"energy" = 40, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1)
	flags_inv = HIDEHAIR
	strip_delay = 40
...
/obj/item/clothing/head/helmet/space/hardsuit/ert
	...
	armor = list("melee" = 65, "bullet" = 50, "laser" = 50, "energy" = 60, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 80, "stab" = 1, "slash" = 1, "crush" = 1)
	strip_delay = 130
	brightness_on = 7
...
/obj/item/clothing/suit/space/eva
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 20, "fire" = 50, "acid" = 65, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/head/helmet/space/freedom
	...
	armor = list("melee" = 20, "bullet" = 40, "laser" = 30, "energy" = 40, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 80, "stab" = 1, "slash" = 1, "crush" = 1)
	strip_delay = 130
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/space/hardsuit/carp
	...
	armor = list("melee" = -20, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 75, "fire" = 60, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1)	//As whimpy as a space carp
...
/obj/item/clothing/suit/space/hardsuit/carp
	...
	armor = list("melee" = -20, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 75, "fire" = 60, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1) //As whimpy whimpy whoo
...
/obj/item/clothing/head/helmet/space/fragile
	...
	armor = list("melee" = 5, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 10, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
	strip_delay = 65
...
/obj/item/clothing/suit/space/hunter
	...
	inhand_icon_state = "swat_suit"
	allowed = list(/obj/item/gun, /obj/item/ammo_box, /obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/restraints/handcuffs, /obj/item/tank/internals, /obj/item/kitchen/knife/combat)
	armor = list("melee" = 60, "bullet" = 40, "laser" = 40, "energy" = 50, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1)
	strip_delay = 130
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/space/hardsuit/combatmedic
	...
	armor = list("melee" = 35, "bullet" = 10, "laser" = 20, "energy" = 30, "bomb" = 5, "bio" = 100, "rad" = 50, "fire" = 65, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1)
