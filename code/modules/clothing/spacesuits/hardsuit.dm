...
/obj/item/clothing/head/helmet/space/hardsuit
	...
	max_integrity = 300
	armor = list("melee" = 10, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 50, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/space/hardsuit
	...
	max_integrity = 300
	armor = list("melee" = 10, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 50, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine
	...
	icon_state = "hardsuit0-engineering"
	inhand_icon_state = "eng_helm"
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 100, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine/atmos
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 25, "fire" = 100, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine/elite
	...
	hardsuit_type = "white"
	armor = list("melee" = 40, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 90, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/mining
	...
	resistance_flags = FIRE_PROOF
	heat_protection = HEAD
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 15)
	brightness_on = 7
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi
	...
	hardsuit_type = "syndi"
	armor = list("melee" = 40, "bullet" = 50, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 90, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 25)
	on = TRUE
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi/elite
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 50, "energy" = 60, "bomb" = 55, "bio" = 100, "rad" = 70, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 25)
	heat_protection = HEAD
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/space/hardsuit/wizard
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 50, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 30)
	heat_protection = HEAD												//Uncomment to enable firesuit protection
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/space/hardsuit/medical
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/rd
	...
	max_heat_protection_temperature = FIRE_SUIT_MAX_TEMP_PROTECT
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 100, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 80, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 15)
...
/obj/item/clothing/head/helmet/space/hardsuit/security
	...
	hardsuit_type = "sec"
	armor = list("melee" = 35, "bullet" = 15, "laser" = 30,"energy" = 40, "bomb" = 10, "bio" = 100, "rad" = 50, "fire" = 75, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 20)
...
/obj/item/clothing/head/helmet/space/hardsuit/security/hos
	...
	hardsuit_type = "hos"
	armor = list("melee" = 45, "bullet" = 25, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 100, "rad" = 50, "fire" = 95, "acid" = 95, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 25)
...
/obj/item/clothing/head/helmet/space/hardsuit/swat
	...
	armor = list("melee" = 40, "bullet" = 50, "laser" = 50, "energy" = 60, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 15)
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/space/hardsuit/clown
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 60, "acid" = 30, "stab" = 1, "slash" = 1, "crush" = 1)
	hardsuit_type = "clown"
...
/obj/item/clothing/head/helmet/space/hardsuit/ancient
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 5, "energy" = 15, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 75, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/space/hardsuit/shielded
	...
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/security/hos
	allowed = null
	armor = list("melee" = 30, "bullet" = 15, "laser" = 30, "energy" = 40, "bomb" = 10, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 15)
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/suit/space/hardsuit/shielded/ctf
	...
	armor = list("melee" = 0, "bullet" = 30, "laser" = 30, "energy" = 40, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 95, "stab" = 1, "slash" = 1, "crush" = 1)
	slowdown = 0
	max_charges = 5
...
/obj/item/clothing/suit/space/hardsuit/shielded/syndi
	...
	inhand_icon_state = "syndie_hardsuit"
	hardsuit_type = "syndi"
	armor = list("melee" = 40, "bullet" = 50, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 30)
	allowed = list(/obj/item/gun, /obj/item/ammo_box, /obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/melee/transforming/energy/sword/saber, /obj/item/restraints/handcuffs, /obj/item/tank/internals)
...
/obj/item/clothing/suit/space/hardsuit/shielded/swat
	...
	current_charges = 4
	recharge_delay = 15
	armor = list("melee" = 80, "bullet" = 80, "laser" = 50, "energy" = 60, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 30)
	strip_delay = 130
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
