...
/obj/item/clothing/gloves/botanic_leather
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 70, "acid" = 30, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/gloves/combat
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/gloves/bracer
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list("melee" = 15, "bullet" = 25, "laser" = 15, "energy" = 15, "bomb" = 20, "bio" = 10, "rad" = 0, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/gloves/color/plasmaman
	...
	resistance_flags = NONE
	permeability_coefficient = 0.05
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 0, "fire" = 95, "acid" = 95, "stab" = 1, "slash" = 1, "crush" = 1)
