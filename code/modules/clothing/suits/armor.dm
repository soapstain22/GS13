/obj/item/clothing/suit/armor
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10, "slash" = 35, "stab" = 35, "crush" = 35)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/hos
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 70, "acid" = 90, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/suit/armor/vest/capcarapace
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 50, "energy" = 50, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
	dog_fashion = null
...
/obj/item/clothing/suit/armor/riot
	...
	armor = list("melee" = 50, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 80, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 20)
...
/obj/item/clothing/suit/armor/bone
	...
	blood_overlay_type = "armor"
	armor = list("melee" = 35, "bullet" = 25, "laser" = 25, "energy" = 35, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/suit/armor/bulletproof
	...
	inhand_icon_state = "armor"
	blood_overlay_type = "armor"
	armor = list("melee" = 15, "bullet" = 60, "laser" = 10, "energy" = 10, "bomb" = 40, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 20)
	strip_delay = 70
...
/obj/item/clothing/suit/armor/laserproof
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 60, "energy" = 60, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/armor/riot/knight/greyscale
	...
	armor = list("melee" = 35, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 10, "bio" = 10, "rad" = 10, "fire" = 40, "acid" = 40, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 15)
...
/obj/item/clothing/suit/armor/vest/russian
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 0, "energy" = 10, "bomb" = 10, "bio" = 0, "rad" = 20, "fire" = 20, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
...
/obj/item/clothing/suit/armor/vest/russian_coat
	...
	cold_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	min_cold_protection_temperature = SPACE_SUIT_MIN_TEMP_PROTECT
	armor = list("melee" = 25, "bullet" = 20, "laser" = 20, "energy" = 30, "bomb" = 20, "bio" = 50, "rad" = 20, "fire" = -10, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
