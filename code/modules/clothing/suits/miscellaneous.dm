...
/obj/item/clothing/suit/jacket/leather
	...
	armor = list("melee" = 3, "bullet" = 9, "laser" = 5,"energy" = 3, "bomb" = 0, "bio" = 30, "rad" = 0, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/jacket/puffer
	...
	inhand_icon_state = "hostrench"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 50, "rad" = 0, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/jacket/puffer/vest
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 30, "rad" = 0, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/jacket/miljacket
	...
	armor = list("melee" = 6, "bullet" = 12, "laser" = 10,"energy" = 0, "bomb" = 14, "bio" = 30, "rad" = 0, "fire" = 0, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
	slowdown = 0.05
	custom_price = 700
...
/obj/item/clothing/suit/hooded/wintercoat/captain
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/hooded/wintercoat/security
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 45, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/hooded/wintercoat/medical
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 50, "rad" = 0, "fire" = 0, "acid" = 45, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/hooded/wintercoat/engineering
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 20, "fire" = 30, "acid" = 45, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/bronze
	...
	armor = list("melee" = 5, "bullet" = 0, "laser" = -5, "energy" = -15, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 20, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/suit/coordinator
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 25, "energy" = 35, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1)
