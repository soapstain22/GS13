...
/obj/item/clothing/under/rank/security/officer
	...
	armor = list("melee" = 10, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 30, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
	strip_delay = 50
...
/obj/item/clothing/under/rank/security/head_of_security
	...
	icon_state = "rhos"
	inhand_icon_state = "r_suit"
	armor = list("melee" = 10, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1, "wound" = 10)
	strip_delay = 60
	alt_covers_chest = TRUE
	sensor_mode = 3
	random_sensor = FALSE
