...
/obj/item/clothing/accessory/medal/plasma
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = -10, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1) //It's made of plasma. Of course it's flammable.
...
/obj/item/clothing/accessory/talisman
	...
	icon_state = "talisman"
	armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 20, "bio" = 20, "rad" = 5, "fire" = 0, "acid" = 25, "stab" = 1, "slash" = 1, "crush" = 1)
	attachment_slot = null
