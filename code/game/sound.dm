...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("snap")
				soundin = pick('sound/effects/wsnap.ogg', 'sound/effects/wsnap.ogg')
			if ("crunch")
				soundin = pick('sound/effects/wcrunch.ogg', 'sound/effects/wcrunch.ogg')
			if ("smash")
				soundin = pick('sound/effects/wsmash.ogg', 'sound/effects/wsmash.ogg')
			if ("ricochet")
