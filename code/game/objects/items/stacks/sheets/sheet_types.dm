...
/obj/item/stack/sheet/plasteel
	...
	throwforce = 10
	flags_1 = CONDUCT_1
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 80, "stab" = 1, "slash" = 1, "crush" = 1)
	resistance_flags = FIRE_PROOF
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	new/datum/stack_recipe("wood bed", /obj/structure/bed/wood, 4, time = 10, one_per_turf = TRUE, on_floor = TRUE), \
	...
	new/datum/stack_recipe("arrow", /obj/item/ammo_casing/arrow, 1, time = 15),
	new/datum/stack_recipe("mortar", /obj/item/reagent_containers/glass/mortar, 3), \
	new/datum/stack_recipe("firebrand", /obj/item/match/firebrand, 2, time = 100), \
	new/datum/stack_recipe("loom", /obj/structure/loom, 1, time = 15, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
...
/obj/item/stack/sheet/mineral/wood
	...
	sheettype = "wood"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
...
GLOBAL_LIST_INIT(bamboo_recipes, list ( \
	...
	new/datum/stack_recipe("recorder", /obj/item/instrument/recorder, 10, time = 100)\
	))
