...
/obj/item/paper/fluff/friends
	name = "note"
	desc = "It's from Max"
	info = "Hey guys.<BR><BR> I hope that you find this at some point, and not some random person. If you are reading this, I'm probably in college. Thanks for hanging around long enough to see me finally finish something. I guess I lost track of time, and now I have to go. I may still be around, but I may not have the energy that I used to. I hope we all can hang out sometime. <BR><BR> You guys are the best."
