...
/obj/item/clothing/suit/armor/plate/crusader
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 60, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/clothing/head/helmet/plate/crusader/prophet
	...
	flags_1 = 0
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 60, "bomb" = 70, "bio" = 50, "rad" = 50, "fire" = 60, "acid" = 60, "stab" = 1, "slash" = 1, "crush" = 1) //religion protects you from disease and radiation, honk.
	worn_x_dimension = 64
	worn_y_dimension = 64
...
/obj/item/clothing/shoes/plate
	...
	icon_state = "crusader"
	w_class = WEIGHT_CLASS_NORMAL
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 60, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60, "stab" = 1, "slash" = 1, "crush" = 1) //does this even do anything on boots?
