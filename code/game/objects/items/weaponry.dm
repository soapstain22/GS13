/obj/item/banhammer
	...
	max_integrity = 200
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 70, "stab" = 1, "slash" = 1, "crush" = 1)
...
/obj/item/claymore
	...
	max_integrity = 200
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 50, "stab" = 1, "slash" = 1, "crush" = 1)
	resistance_flags = FIRE_PROOF
