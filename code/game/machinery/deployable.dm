...
/obj/structure/barricade/wooden/attackby(obj/item/I, mob/user)
	if(istype(I,/obj/item/stack/sheet/mineral/wood))
		...
		if(W.amount < 3)
			to_chat(user, "<span class='warning'>You need at least three wooden planks to make a wall!</span>")
			return
		else
...
/obj/structure/barricade/sandbags/attackby(obj/item/I, mob/user)
	if(istype(I,/obj/item/stack/sheet/mineral/sandstone))
		var/obj/item/stack/sheet/mineral/sandstone/W = I
		if(W.amount < 3)
			...
			if(do_after(user, 25, target=src))
				W.use(3)
				var/turf/T = get_turf(src)
				T.PlaceOnTop(/turf/closed/wall/mineral/sandstone/nonmetal)
				qdel(src)
				return
	return ..()
/obj/structure/barricade/security
	...
	max_integrity = 180
	proj_pass_rate = 20
	armor = list("melee" = 10, "bullet" = 50, "laser" = 50, "energy" = 50, "bomb" = 10, "bio" = 100, "rad" = 100, "fire" = 10, "acid" = 0, "stab" = 1, "slash" = 1, "crush" = 1)
